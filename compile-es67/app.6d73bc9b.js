...
var _defineProperty = _interopRequireDefault(__webpack_require__(82));
...
var dP = _defineProperty.default;
exports.f = __webpack_require__(7) ? _defineProperty.default : function defineProperty(O, P, Attributes) {
  anObject(O);
...
var _typeof4 = _interopRequireDefault(__webpack_require__(15));

var _Symbol$iterator = __webpack_require__(85);
...
var $at = __webpack_require__(87)(true); // 21.1.3.27 String.prototype[@@iterator]()
...
var _create = _interopRequireDefault(__webpack_require__(50));
...
var _keys = _interopRequireDefault(__webpack_require__(94));
...
var _preventExtensions = _interopRequireDefault(__webpack_require__(104));

var _isExtensible = _interopRequireDefault(__webpack_require__(107));
...
var _getOwnPropertyDescriptor = _interopRequireDefault(__webpack_require__(113));
...
var gOPD = _getOwnPropertyDescriptor.default;
...
var _defineProperties = _interopRequireDefault(__webpack_require__(91));
...
module.exports = __webpack_require__(7) ? _defineProperties.default : function defineProperties(O, Properties) {
  anObject(O);
...
module.exports = _getPrototypeOf.default || function (O) {
  O = toObject(O);
...
var isSymbol = USE_NATIVE && (0, _typeof2.default)($Symbol.iterator) == 'symbol' ? function (it) {
...
var _getOwnPropertySymbols = _interopRequireDefault(__webpack_require__(111));
...
var _getOwnPropertyNames = _interopRequireDefault(__webpack_require__(30));
...
var _from = _interopRequireDefault(__webpack_require__(74));
...
try {
  ...
  (0, _from.default)(riter, function () {
    throw 2;
  });
} catch (e) {
  /* empty */
...
var _regenerator = _interopRequireDefault(__webpack_require__(78));

var _set = _interopRequireDefault(__webpack_require__(133));

var _marked =
/*#__PURE__*/
_regenerator.default.mark(funca);
...
console.log(newArr);
console.log(new _set.default(newArr));

function funca() {
  return _regenerator.default.wrap(function funca$(_context) {
    while (1) {
...
var hadRuntime = g.regeneratorRuntime && (0, _getOwnPropertyNames.default)(g).indexOf("regeneratorRuntime") >= 0; // Save the old regeneratorRuntime in case it needs to be restored later.
...
var defined = __webpack_require__(32); // true  -> String#at
...
$export($export.S + $export.F * !__webpack_require__(7), 'Object', {
  defineProperties: __webpack_require__(51)
});
...
var _promise = _interopRequireDefault(__webpack_require__(120));

var _setPrototypeOf = _interopRequireDefault(__webpack_require__(75));
...
var _symbol = _interopRequireDefault(__webpack_require__(58));
...
!function (global) {
  ...
  var inModule = ( false ? "undefined" : (0, _typeof2.default)(module)) === "object";
...
module.exports = {
  set: _setPrototypeOf.default || ('__proto__' in {} ? // eslint-disable-line
  function (test, buggy, set) {
    try {
      set = __webpack_require__(8)(Function.call, __webpack_require__(43).f(Object.prototype, '__proto__').set, 2);
      set(test, []);
...
$export($export.P + $export.R, 'Set', {
  toJSON: __webpack_require__(142)('Set')
});
